...
public class OrderDao {
  ...
  public void insertExecution(long orderId, int quantity, Date executionDate) {
    Map<String, Object> params = ImmutableMap.of("orderId", orderId, "quantity", quantity, "executionDate", executionDate);
